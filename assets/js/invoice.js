$('.search > input').on('keyup', function() {
  var rex = new RegExp($(this).val(), 'i');
    $('.nav.nav_invoice .nav-item').hide();
    $('.nav.nav_invoice .nav-item').filter(function() {
...
var $btns = $('.list-actions').click(function() {
  ...
  let getDataInvoiceAttr = $(this).attr('data-invoice-id');
  ...
  var setInvoiceNumberDownload = getParentDiv.find('.action-download').attr('href' ,'./orders/pdf/'+ getDataInvoiceAttr);
