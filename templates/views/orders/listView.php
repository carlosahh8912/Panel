...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        ...
        <button onclick="openModal();" class="btn btn-sm btn-dark"><span class="fas fa-plus me-2"></span> Nuevo Pedido</button>
...
<div class="card card-body shadow-sm table-wrapper">
  <table id="ordersTable" class="table table-borderless table-striped table-hover align-items-center datatable">
    <thead>
      <tr>
        <th class="border-bottom">#</th>
        <th class="border-bottom">Gava id</th>
        <th class="border-bottom">Cliente</th>
        <th class="border-bottom">Subtotal</th>
        <th class="border-bottom">Descuento</th>
        <th class="border-bottom">Impuesto</th>
