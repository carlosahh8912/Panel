...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <?php if ($_SESSION['permissions'][6]['w'] == 1) :?>
        <button onclick="openModal();" class="btn btn-sm btn-dark"><span class="fas fa-plus me-2"></span> Nuevo Producto</button>
...
<div class="card card-body shadow-sm table-wrapper">
  <table id="productsTable" class="table table-borderless table-striped table-hover align-items-center datatable">
    <thead>
      <tr>
        <th class="border-bottom">SKU</th>
        <th class="border-bottom">Título</th>
        <th class="border-bottom">EAN</th>
        <th class="border-bottom">Precio</th>
        <th class="border-bottom">Stock</th>
        <th class="border-bottom">Novedad</th>
        <th class="border-bottom">Top Seller</th>
        <th class="border-bottom">Oferta</th>
