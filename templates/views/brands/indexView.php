...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <?php if ($_SESSION['permissions'][7]['w'] == 1) :?>
        <button onclick="openModal();" class="btn btn-sm btn-dark"><span class="fas fa-plus me-2"></span> Nuevo Marca</button>
...
<div class="card card-body shadow-sm table-wrapper">
  <table id="brandsTable" class="table table-borderless table-striped table-hover align-items-center datatable">
    <thead>
      <tr>
