...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        ...
        <button onclick="openModal();" class="btn btn-sm btn-dark"><span class="fas fa-plus me-2"></span> Nuevo Cliente</button>
...
<div class="card card-body shadow-sm table-wrapper">
    <table id="customersTable" class="table table-borderless table-striped table-hover align-items-center datatable">
        <thead>
        <tr>
            <th class="border-bottom">SAE</th>
            <th class="border-bottom">Nombre</th>
            <th class="border-bottom">email</th>
            <th class="border-bottom">B2B</th>
            <th class="border-bottom">Dropshiping</th>
